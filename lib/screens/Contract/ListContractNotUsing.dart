...
class ListContractNotUsing extends StatefulWidget {
  final List<Contract> list;
  const ListContractNotUsing({ Key key, @required this.list }) : super(key: key);

  @override
  _ListContractNotUsingState createState() => _ListContractNotUsingState();
}

class _ListContractNotUsingState extends State<ListContractNotUsing> {
  @override
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text('${widget.list[index].status == false ? 'Chưa sử dụng' : ''}', style: TextStyle(fontSize: 21, fontWeight: FontWeight.w600, color: Colors.blue),),
                        ),
                        SizedBox(
                          height: 5,
                        ),
                        Text('Hợp đồng phòng ${widget.list[index].roomId}', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w600),),
                        SizedBox(
                          height: 5,
                        ),
                        Divider(
